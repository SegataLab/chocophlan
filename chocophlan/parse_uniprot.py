    ...
    if elem is not None:
        ...
        try:
            ...
            if is_taxon_processable(taxid):
                ...
                members = list(set(elem.xpath('/proteome/canonicalGene/gene/@accession | /proteome/canonicalGene/gene/@geneName', smart_strings=False)))
                members = list(zip(members[1::2], members[::2]))
