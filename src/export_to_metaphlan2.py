...
def run_all():
    ...
    os.system('cat {}/{}/markers_fasta/*.fna > {}/{}/{}.markers.fna'.format(config['export_dir'], config['exportpath_metaphlan2'],config['export_dir'], config['exportpath_metaphlan2'],outfile_prefix))
